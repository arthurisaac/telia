final String appName = "Telia";
final String packageName = "com.sondo.telia";
...
final String minimumFreeDeliveryOrderAmountBoxKey =
...
final String databaseUrl = 'https://telia.fasobizness.com/app/v1';
final String baseUrl = databaseUrl + '/api/';
final String perPage = "10";
//
final String jwtKey = '1d427f1b8890e7f08cb5e6e26a1ff89c40e41aee';
final String googleAPiKeyAndroid = "AIzaSyBgT55LZY5wXrxcb0-hNfrFsEKM3XeBMaE";
final String googleAPiKeyIos = "PLACE_YOUR_MAP_KEY_IOS";

// Mapbox API
final String mapBoxAccessToken = 'sk.eyJ1IjoiYXJ0aHVyMjQiLCJhIjoiY2xlb3Y4aWFuMDJ1azN0cnV3ZTdvbDJtaSJ9.ArgpFzsRYDLJmFceglz5hQ';
final String mapBoxStyleId = 'ckm0pyd0s9gfe17mw5z6go656';
...
final String paypalTransactionWebviewUrl =
...
final String flutterwavePaymentResponseUrl =
